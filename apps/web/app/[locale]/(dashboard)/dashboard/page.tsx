    ...
    <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem', marginBottom: '3rem' }}>
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '16px', padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div style={{ fontSize: '2.5rem', fontWeight: 800, color: 'var(--text)' }}>
            0 <span style={{ fontSize: '1rem', color: 'var(--text-muted)', fontWeight: 500 }}>Días</span>
          </div>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '16px', padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>Pérdidas reportadas en este mes.</p>
        </div>
      </div>
      ...
      <section style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '16px', padding: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
          <button style={{ flex: 1, minWidth: '200px', padding: '1rem', borderRadius: '12px', background: 'var(--grad)', color: '#fff', border: 'none', fontWeight: 600, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', cursor: 'pointer', opacity: 0.5 }}>
            <Plus size={18} /> Bloquear nuevo sitio
          </button>
          <button style={{ flex: 1, minWidth: '200px', padding: '1rem', borderRadius: '12px', background: 'var(--bg-2)', color: 'var(--text)', border: '1px solid var(--border)', fontWeight: 600, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', cursor: 'pointer', opacity: 0.5 }}>
            <TrendingDown size={18} /> Registrar pérdida
          </button>
          <button style={{ flex: 1, minWidth: '200px', padding: '1rem', borderRadius: '12px', background: 'rgba(20,184,166,0.1)', color: 'var(--teal)', border: '1px solid rgba(20,184,166,0.2)', fontWeight: 600, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', cursor: 'pointer', opacity: 0.5 }}>
            <Users size={18} /> Invitar Guardián
          </button>
        </div>
        <p style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.85rem', color: 'var(--text-muted)' }}>⚠️ Estas funciones están en construcción (Siguiente fase del MVP).</p>
      </section>
    </div>
  );
}
